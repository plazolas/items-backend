...
// @SpringBootTest
@ContextConfiguration(locations={"file:c:/Users/oplaz/dev/items-backend/src/main/resources/META-INF/persistence.xml"})
...
//		this.countryService.saveCountry(country);
		...
		this.personService.addPerson("ron", "jon", country,"CEO",45, 1);
	}
...
//            assertFalse(pais.getName().isEmpty());
//			countryMap.put(pais.getName(),pais.getId().intValue());
//		});
